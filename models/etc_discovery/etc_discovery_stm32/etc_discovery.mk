# 
# File    : etc_discovery.mk
#
# $ etc_discovery.mk 2011-10-03 dlange $
#
#
# Abstract:
...
TARGET_PATH = "D:\stm32-throttle-controller\tools\STM32"
...
#                        of executable (1/0)?
MODEL                = etc_discovery
MODULES              = etc_discovery_ADC.c etc_discovery_TIM.c main.c 
MODULES_OBJ          = etc_discovery_ADC.obj etc_discovery_TIM.obj main.obj 
MAKEFILE             = etc_discovery.mk
...
NUMST                = 1
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 DOWNLOADAPPLICATION=1 STM32CUBEMXPATHUPDATE=1 STM32CUBEMXPATH="C:\Program Files\STMicroelectronics\STM32Cube\STM32CubeMX" TARGET_INST_FULLPATH="D:\stm32-throttle-controller\tools\STM32" IOC_FULLPATH=".\etc_discovery.ioc" IT_HANDLER_OPTIM=1 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB             = etc_discoverylib.lib
MODELREF_LINK_LIBS   = 
MODELREF_LINK_RSPFILE     = etc_discovery_ref.rsp
MODELREF_INC_PATH         =  
...
# Additional includes 
ADD_INCLUDES = \
	-ID:/stm32-throttle-controller/models/etc_discovery/etc_discovery_stm32 \
	-ID:/stm32-throttle-controller/models/etc_discovery \
	-ID:/stm32-throttle-controller/tools/STM32/addSrc/inc \
...
%.o: $(subst ",,D:/stm32-throttle-controller/tools/STM32/addSrc/src)/%.cpp
	@$(CC) $(CFLAGS) $< 
	@echo ### Successfully compiled source $<
...
%.o: $(subst ",,D:/stm32-throttle-controller/tools/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Start compile EXPAND $(SRC_FILE_EXT) source $<
	@echo ### Successfully compiled source $<
...
%.o: $(subst ",,D:/stm32-throttle-controller/tools/STM32/addSrc/src)/%$(ASM_FILE_EXT)
	@echo ### Start compile EXPAND $(ASM_FILE_EXT) source $<
	@echo ### Successfully compiled source $<
