...
TARGET_PATH = "D:\Users\Kevin\Documents\MATLAB\STM32-~1\STM32"
...
#                        of executable (1/0)?
MODEL                = etc
MODULES              = etc_ADC.c etc_TIM.c main.c 
MODULES_OBJ          = etc_ADC.obj etc_TIM.obj main.obj 
MAKEFILE             = etc.mk
...
NUMST                = 1
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 DOWNLOADAPPLICATION=1 STM32CUBEMXPATHUPDATE=1 STM32CUBEMXPATH="C:\Program Files\STMicroelectronics\STM32Cube\STM32CubeMX" TARGET_INST_FULLPATH="D:\Users\Kevin\Documents\MATLAB\STM32-MAT\STM32" IOC_FULLPATH=".\etc.ioc" IT_HANDLER_OPTIM=1 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB             = etclib.lib
MODELREF_LINK_LIBS   = 
MODELREF_LINK_RSPFILE     = etc_ref.rsp
MODELREF_INC_PATH         =  
...
# Additional includes 
ADD_INCLUDES = \
	-ID:/Users/Kevin/Documents/MATLAB/etc/etc_stm32 \
	-ID:/Users/Kevin/Documents/MATLAB/etc \
	-ID:/Users/Kevin/Documents/MATLAB/STM32-MAT/STM32/addSrc/inc \
...
%.o: $(subst ",,D:/Users/Kevin/Documents/MATLAB/STM32-MAT/STM32/addSrc/src)/%.cpp
	@$(CC) $(CFLAGS) $< 
	@echo ### Successfully compiled source $<
...
%.o: $(subst ",,D:/Users/Kevin/Documents/MATLAB/STM32-MAT/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Start compile EXPAND $(SRC_FILE_EXT) source $<
	@echo ### Successfully compiled source $<

%.o: $(subst ",,..)/%$(SRC_FILE_EXT)
	@echo ### Start compile EXPAND $(SRC_FILE_EXT) source $<
	@echo ### Successfully compiled source $<
...
%.o: $(subst ",,D:/Users/Kevin/Documents/MATLAB/STM32-MAT/STM32/addSrc/src)/%$(ASM_FILE_EXT)
	@echo ### Start compile EXPAND $(ASM_FILE_EXT) source $<
	@echo ### Successfully compiled source $<

%.o: $(subst ",,..)/%$(ASM_FILE_EXT)
	@echo ### Start compile EXPAND $(ASM_FILE_EXT) source $<
	@echo ### Successfully compiled source $<
